...
const KnowledgeCenter: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Essential security measures every blockchain developer should implement in their projects.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Choose the right hardware for your AI and machine learning projects with our comprehensive guide.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Advanced tips and tricks for developing efficient and secure smart contracts.",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Exploring trends and predictions for the future of decentralized commerce and technology.",
      image:
        ...
        <section className="bg-gradient-to-r from-primary/10 to-secondary/10 py-16">
          <div className="relative max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              practices in decentralized computing
            </p>

            {/* Search Bar */}
            <div className="max-w-md mx-auto relative">
              <Input placeholder="Search articles..." className="pr-12" />
              <Button size="icon" className="absolute right-1 -top-0">
