      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Whether you're new to decentralized tech or a seasoned pro, our marketplace makes it easy to find and use powerful computing resources for your projects.
            </p>
            <Link to="/marketplace">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Resources for small experiments to enterprise-grade projects.
                  </p>
                </CardContent>
              </Card>
              <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
            ...
            <div className="mt-12 text-center">
              <blockquote className="text-lg italic text-muted-foreground">
                "Scaling my dream tech project was effortless! Thank you for making everything so simple. – Anagh Raj, Lead Dev at Brand Kiln"
              </blockquote>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Three Easy Steps to Power Your Project</h2>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Discover the Right Resources for Your Needs</h2>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Rent or buy computing power for a variety of tasks- from AI model training to Blockchain software. Optimize your go-to-market… from weeks to hours.
                  </p>
                  {showComputeDetails && (
                    <div className="mt-4 p-4 bg-muted rounded-lg">
                      <h4 className="font-semibold mb-2">Sample Specs:</h4>
                      <ul className="text-sm text-muted-foreground space-y-1">
                        <li>• AI Models & APIs (GPT Models, Image Recognition, NLP Services)</li>
                        <li>• Data Processing (Big Data, Analytics, ETL Pipelines)</li>
                        <li>• Oracles & Automation (Price Feeds, Smart Contracts, Triggers)</li>
                        <li>• Blockchain Services (Node Hosting, dApp Backend, Deployment)</li>
                      </ul>
                    </div>
                  )}
                </CardContent>
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Lease or buy the right hardware at best prices. No more scouting for devices to power your dream project… its all here.
                  </p>
                  {showHardwareDetails && (
                    <div className="mt-4 p-4 bg-muted rounded-lg">
                      <h4 className="font-semibold mb-2">Sample Specs:</h4>
                      <ul className="text-sm text-muted-foreground space-y-1">
                        <li>• Edge & Smart Devices (IoT Gateways, Smart Sensors, Edge Computers)</li>
                        <li>• Accelerator Units (GPU Cards, FPGA Boards, ASIC Miners)</li>
                        <li>• Storage & Data Nodes (NAS Systems, SSD Arrays, Distributed Storage)</li>
                        <li>• Custom Systems (Custom Rigs, Modular PCs, Specialized Hardware)</li>
                      </ul>
                    </div>
                  )}
                </CardContent>
