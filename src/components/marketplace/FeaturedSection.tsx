...
const FeaturedSection: React.FC = () => {
  const featuredItems: FeaturedItem[] = [
    ...
    },
    {
      ...
      image:
        "https://unsplash.com/photos/a-payment-terminal-sits-on-a-stores-checkout-table-5RVD3VVNWeI",
      discount: "40%",
      inStock: true,
    ...
    },
    {
      ...
      description:
        "Advanced computer vision platform for image recognition and analysis",
    ...
    },
    {
      ...
      description:
        "Compact edge computing solution for IoT and distributed processing",
      image:
