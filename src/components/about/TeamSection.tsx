...
const TeamSection: React.FC = () => {
  const advisors = [
    {
      ...
      focus: "Marketing",
      description:
        "This former CEO (global Edge Compute leader brand) brings 20+ yrs avg. expertise of brand marketing and sales expertise alongside his vast network of Web3 innovator brands",
      linkedinUrl: "https://www.linkedin.com/in/evan-rodenberg/",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117800683_8fef5bfb.jpeg",
    },
    {
      ...
      focus: "Solution",
      description:
        "This founder & CEO of Flux Point Studios is a rising star in AI and Web3, backing our solutionism with deep tech fluency.",
      linkedinUrl: "https://www.linkedin.com/in/nathaniel-minton/",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117803414_4e2697f9.jpg",
    },
    {
      ...
      focus: "Strategy",
      description:
        "This seasoned leader brings 30+ yrs avg. expertise of corporate leadership and entrepreneurship across blockchain, crypto, telecom, and decentralized compute.",
      linkedinUrl: "https://www.linkedin.com/in/ronaldvorstenbosch/",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117804242_c52a229d.jpg",
    },
    {
      name: "Raymond Mata",
      country: "USA",
      focus: "Blockchain",
      description:
        "This blockchain enthusiast and elite coder is the Product Leader at a top global Web3 brand and brings 25+ yrs avg. expertise alongside understanding of decentralized communities.",
      linkedinUrl: "https://x.com/PoolGrow",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117804992_75ab7af1.jpeg",
    },
    {
      name: "Cole Bartlett",
      country: "USA",
      ...
      description:
        "This celebrated Web3 Influencer is an ardent blockchain protagonist, a published author and a voice of the tech savvy global citizen bridging US, EU and LATAM communities.",
      linkedinUrl: "https://www.linkedin.com/in/cole-bartlett/",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117805943_0da57f66.jpg",
    },
    {
      ...
      description:
        "This international legal expert brings 30 yrs avg. expertise advising big-tech enterprises as well as scale-up organizations across the EU, USA, and beyond.",
      linkedinUrl: "https://www.linkedin.com/in/martijn-aardema-449338/",
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117806803_5d17a422.jpeg",
    },
  ];
  ...
  const founders = [
    {
      ...
      imageUrl:
        "https://d64gsuwffb70l.cloudfront.net/6860d25c16551e9c1ce34e45_1752117854409_c72906ff.jpg",
    },
    {
      name: "Yoonil Choi",
      country: "South Korea",
  ...
  return (
    <section
      id="team"
      className="py-16 px-4 bg-gradient-to-br from-background via-background to-blue-50 dark:to-blue-950/20 relative overflow-hidden"
    >
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-blue-100 dark:bg-blue-900/30 rounded-lg p-4 max-w-2xl mx-auto border border-blue-200 dark:border-blue-800">
            <p className="text-lg font-semibold text-blue-700 dark:text-blue-300">
              Spread across 5 nations & 3 continents.
              <br />
        ...
        <div className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {advisors.map((advisor, index) => (
              <FlippableCard key={index} {...advisor} type="advisor" />
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-6">
            {founders.map((founder, index) => (
              <FlippableCard key={index} {...founder} type="founder" />
            ))}
          </div>
        </div>
      </div>
