...
//     <section
//       id="roadmap"
//       className="py-20 px-4 bg-gradient-to-br from-background via-background to-blue-50 dark:to-blue-950/20"
//     >
...
//               <Card
//                 key={index}
//                 className="hover:shadow-xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 bg-gradient-to-br from-card to-card/80 border border-border/50 group"
//               >
//                 <CardHeader>
...
//                     </Badge>
//                     <div
//                       className={`w-12 h-12 ${phase.color} rounded-full flex items-center justify-center group-hover:rotate-12 transition-transform`}
//                     >
...
const RoadmapSection = () => {
  ...
  return (
    <section
      id="roadmap"
      className="py-20 px-4 bg-gradient-to-br from-white via-white to-blue-50 relative"
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {phases.map((phase, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 border border-gray-200 group p-6"
              >
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <span
        ...
        <div className="text-center mt-12">
          <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 text-lg font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center mx-auto">
            <Rocket className="mr-2 h-5 w-5" />
            Join Our Journey
          </button>
        </div>
