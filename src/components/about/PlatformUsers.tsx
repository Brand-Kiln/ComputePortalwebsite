      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Empowering diverse communities with decentralized technology
            solutions
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {personas.map((persona, index) => {
            ...
            return (
              <Card
                key={index}
                className={`text-center hover:shadow-xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 ${persona.bgColor} border border-border/50 relative overflow-hidden group`}
              >
                ...
                <CardHeader className="pb-4">
                  <div className="flex justify-center mb-6">
                    <div
                      className={`w-20 h-20 bg-gradient-to-r ${persona.gradient} rounded-full flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:rotate-12`}
                    >
