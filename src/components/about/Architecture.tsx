        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {layers.map((layer, index) => {
            ...
            return (
              <Card
                key={index}
                className={`${layer.bgColor} border-0 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2`}
              >
                <CardHeader className="text-center pb-6">
                  <div
                    className={`w-20 h-20 bg-gradient-to-r ${layer.gradient} rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg`}
                  >
